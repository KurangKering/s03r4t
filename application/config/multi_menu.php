...
$config["children_tag_open"]     = '<ul class="nav child_menu">';	
...
$config["tahap_satu"] = array(10);
$config["tahap_dua"] = array(30, 40);
$config["tahap_tiga"] = array(50, 60);
