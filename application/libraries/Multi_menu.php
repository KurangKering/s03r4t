...
class Multi_menu {
	...
	* 
    ...
    private function render_item_baru($items, &$html = '')
    {
    	...
    	{
    		$nav_tag_opened = true;
    		$html .= PHP_EOL . $this->nav_tag_open . PHP_EOL;
    		...
    		if ( isset($item[$this->menu_label], $item[$this->menu_key]) ) 
    		{
    			...
    			{	        	
    				...
    				if ( is_null($item[$this->menu_parent]) && $this->parentl1_tag_close != '' ) {
    					$html .= PHP_EOL . $this->parentl1_tag_close . PHP_EOL;
    				}
    				else {
    					$html  .= PHP_EOL . $this->parent_tag_close . PHP_EOL;
    				}	            
    			}
    			else {
    				$html .= PHP_EOL . $this->item_tag_close. PHP_EOL; 
    			}
    	...
    	if (isset($nav_tag_opened)) 
    	{
    		...
    		$html .= PHP_EOL. $this->nav_tag_close . PHP_EOL; 
    	}
    	else {	   
    		$html  .= PHP_EOL . $this->children_tag_close . PHP_EOL;
    	}
