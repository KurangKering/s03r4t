      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>SIM SURAT<span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <ul class="nav side-menu">
              <li><a><i class="fa fa-home"></i> Access <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="<?php echo base_url('access/lihat_users') ?>">Manage Users</a></li>
                  <li><a href="<?php echo base_url('access/lihat_groups') ?>">Manage Groups</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li role="presentation" class="dropdown">
              ...
              <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                <li>
                  <a>
                    <span class="image"><img src="<?php echo base_url('template/gentelella/production/') ?>images/img.jpg" alt="Profile Image" /></span>
                    <span>
