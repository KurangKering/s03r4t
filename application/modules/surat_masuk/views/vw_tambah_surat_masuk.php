      ...
      <div class="x_title">
        <h2>Form Tambah Surat Masuk</h2>
                  ...
                  <div class="item form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  value="<?php set_value('tanggal_masuk'); ?>" id="tanggal_masuk" data-inputmask="'mask': '99/99/9999'"  class="form-control col-md-7 col-xs-12" name="tanggal_masuk"  required="required" type="text">
                  </div>
                </div>
                <div class="item form-group">
