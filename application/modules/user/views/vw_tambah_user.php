                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="username" class="form-control col-md-7 col-xs-12" name="username" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="telephone" name="phone" required="required"  class="form-control col-md-7 col-xs-12" type="tel">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="expired" data-inputmask="'mask': '99/99/9999'" name="expired" required="required"  class="form-control col-md-7 col-xs-12" type="date">
                        </div>
                      </div>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="col-md-7">
                            <?php foreach (array_slice($groups, 0, count($groups)/2) as $key => $value): ?>
                              ...
                              <div class="">
                                <label>
                                  <input name="groups[]" type="checkbox" class="flat" value="<?php echo $value->id; ?>"> <?php echo $value->name; ?>
                                </label>
                              </div>
                            <?php endforeach ?>
                          </div>
